...
title: OpenAI
category: entity
summary: AI lab behind ChatGPT and Codex; catalog-ads-only FB pattern was SEXTUPLE-confirmed across 8 batches and BROKEN in 2026-05-22 batch 9 when OpenAI shipped its first static-narrative video ad (Codex retention promo, *"Try Codex for free today"*); 2026-05-23 batch 10 reverted to placeholder-only — batch-9 copy ad was a one-off creative test; **2026-05-26 batch 12 ships 1 new ad** (Cluster 2 expansion, ID `852088814627491` started 2026-05-08) after the batch-11 silence — Cluster 2 now at 14 ads / 18 days post-launch at 0.78 ads/day (near-identical pacing to batches 8-11); **Cluster 3 (2026-05-15) STILL stalled at 3 ads / 1 with copy** after 11 days post-launch (3 consecutive active OpenAI batches without a new Cluster 3 ad — 10+12 with batch 11 silent); one-off creative test reading further locked; cumulative **45 ads across 12 batches, still 1 with copy** — 3 distinct launch windows; in 2026-05-11 named as a six-vendor agent-security responder; **in 2026-05-13 LOSES the business-adoption lead to Anthropic** (per Ramp/EconLab) — and within hours ships [[codex]] free for 2 months as a retention play; ships ACP (with Stripe) as merchant-side checkout protocol in [[agentic-commerce]]; **in 2026-05-15 named alongside [[anthropic]] as axis-1 player in the four-axis squeeze ([[agentic-implementation-layer]])** — both labs standing up deployment companies; OpenAI's paid-social cadence remains ~5.6x Anthropic's (45 vs 8 cumulative FB ads across the same 12-batch window); **in 2026-05-26 OpenAI's data infrastructure engineering team becomes the case study for [[platform-agent-asymmetry]]** — Emma (data platform lead) interviewed by [[nate-b-jones]] in 46-min long-form video on the platform-team-bottleneck failure mode + private eval suite + "platform agents need different primitives" — first inside-OpenAI platform-engineering voice in vault
tags: [organization, ai-lab, openai, codex, chatgpt, competitor, ads, agent-security, business-adoption, ramp-data, retention-promo, free-sample-phase, acp, agentic-commerce, agentic-implementation-layer, deployment-company, axis-1, four-axis-squeeze, cluster-pacing, cluster-3, first-copy-ad-one-off, codex-retention-narrative-stalled, batch-11-silence, platform-agent-asymmetry, emma-openai, data-platform-team, platform-engineering, private-eval-suite, uneven-acceleration, adversarial-agents]
sources: 16
updated: 2026-05-26
---
...
> ⚠️ Pattern BROKEN in batch 9, QUALIFIED in batch 10, FURTHER LOCKED in batch 11: OpenAI shipped its first static-narrative ad in batch 9 (Cluster 3 video, Codex retention promo) but did NOT expand it in batches 10 or 11. Cluster 3 stalls at 3 ads after 10 days post-launch (vs Cluster 2's 12 ads / 15 days). Updated reading: the batch-9 copy ad was a **one-off creative test**, not the opening of a sustained narrative-copy campaign. 43 of 44 ads (97.7%) remain catalog placeholders. Anthropic remains 100% placeholder (8/8 across 11 batches) — lab-comparison delta holds (OpenAI still ~5.5x cadence, copy gap stuck at 1 unexpanded ad).
