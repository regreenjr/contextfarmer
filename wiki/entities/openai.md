...
title: OpenAI
category: entity
summary: AI lab behind ChatGPT and Codex; catalog-ads-only FB pattern was SEXTUPLE-confirmed across 8 batches and BROKEN in 2026-05-22 batch 9 when OpenAI shipped its first static-narrative video ad (Codex retention promo, *"Try Codex for free today"*); **2026-05-23 batch 10 reverts to placeholder-only** (1 Cluster 1 carousel, body `{{product.brand}}`) — **batch-9 copy ad was a one-off creative test, not the opening of a sustained narrative-copy campaign**; **Cluster 3 (2026-05-15) STALLS at 3 ads / 1 with copy after 8 days post-launch** (vs Cluster 2's 12 ads / 15 days); updated structural reading qualifies batch-9 claim — static narrative *was tested* in retention/promotion context but didn't yet *scale*; cumulative **44 ads across 10 batches, still 1 with copy** — 3 distinct launch windows; in 2026-05-11 named as a six-vendor agent-security responder; **in 2026-05-13 LOSES the business-adoption lead to Anthropic** (per Ramp/EconLab) — and within hours ships [[codex]] free for 2 months as a retention play; ships ACP (with Stripe) as merchant-side checkout protocol in [[agentic-commerce]]; **in 2026-05-15 named alongside [[anthropic]] as axis-1 player in the four-axis squeeze ([[agentic-implementation-layer]])** — both labs standing up deployment companies; OpenAI's paid-social cadence remains ~6x Anthropic's (44 vs 7 cumulative FB ads across the same 10-batch window)
tags: [organization, ai-lab, openai, codex, chatgpt, competitor, ads, agent-security, business-adoption, ramp-data, retention-promo, free-sample-phase, acp, agentic-commerce, agentic-implementation-layer, deployment-company, axis-1, four-axis-squeeze, cluster-pacing, cluster-3, first-copy-ad-one-off, codex-retention-narrative-stalled]
sources: 14
updated: 2026-05-23
---
...
> ⚠️ Pattern BROKEN in batch 9, QUALIFIED in batch 10: OpenAI shipped its first static-narrative ad in batch 9 (Cluster 3 video, Codex retention promo) but did NOT expand it in batch 10. Cluster 3 stalls at 3 ads after 8 days post-launch (vs Cluster 2's 12 ads / 15 days). Updated reading: the batch-9 copy ad was a **one-off creative test**, not the opening of a sustained narrative-copy campaign. The structural claim *"catalog-only for cluster expansion, static narrative for retention/promotion"* needs **qualification** — static narrative was tested in retention/promotion context but didn't yet scale there. 43 of 44 ads (97.7%) remain catalog placeholders. Anthropic remains 100% placeholder (7/7) — lab-comparison delta widens slightly (OpenAI still ~6x cadence, copy gap stuck at 1 unexpanded ad).
