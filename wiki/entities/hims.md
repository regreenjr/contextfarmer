...
title: Hims
category: entity
summary: Hims & Hers Health — public DTC telehealth (NYSE:HIMS); 2026 creative engine spans three wedges (GLP-1 / hair-loss / Sex Rx) and pioneers the compounded-drug-disclaimer + "$149/mo + $39 membership" pricing template; 2026-05-10 batch adds "Hard Mints" (4th Sex Rx SKU); inside-structure A/B is the standing pattern; 2026-05-23 batch 10 Hair Hybrids verbatim run extended to 4 batches / 17-day stability window with 6 cumulative post-cold-start re-launches; batches 11+12 formed the first 2-consecutive-batch all-placeholder Hims run; **2026-05-28 batch 13 RETURNS to 2 ads — Hair Hybrids verbatim re-launch #7** (ID `1502428521462699` started 2026-05-14, full copy) **BREAKS the 2-batch Hair Hybrids silence (11+12)** so the wave does NOT reach the ≥3-batch wave-closure threshold — **Hair Hybrids wave remains OPEN** (the 11+12 silence was a single 2-batch trough, not wave closure) + 1 placeholder; **Wegovy 5-batch silent (9+10+11+12+13)** — wave remains structurally closed; Sex Rx silent since batch 7; cumulative **73 ads across 13 batches**
tags: [organization, dtc, telehealth, glp-1, compounded-drugs, hair-loss, sex-rx, hard-mints, competitor, hims, surge-trough-cadence, three-wedge-surge, fetch-gap-compression-confirmed, surge-composition-rotation, hair-hybrids-standing-template, wegovy-wave-closed, all-placeholder-batch, wegovy-5-batch-silent, hair-hybrids-returns, hair-hybrids-wave-open]
sources: 11
updated: 2026-05-28
---
...
(Wegovy silent in batches 9 + 10 + 11 + 12 + 13 — **wave structurally CLOSED at ≥3-batch threshold, now 5-batch silent**.)
...
Hair Hybrids verbatim spans batches **1+8+9+10+13** (2-batch trough at 11+12) with **7 cumulative post-cold-start re-launches**; start dates span ~12 weeks (2026-02-26 → 2026-05-19). **Batch 13's verbatim re-launch #7 BREAKS the 2-batch Hair Hybrids silence (11+12)** — the wave does NOT reach the ≥3-batch wave-closure threshold, so **Hair Hybrids remains OPEN**. The 11+12 silence is now confirmed as a single 2-batch trough (interpretation b), not a wave-closing pattern matching Wegovy (interpretation a). The Wegovy verbatim wave remains structurally CLOSED — now extended to 5-batch silent (9+10+11+12+13). Batch 13 also breaks the first 2-consecutive-batch all-placeholder Hims run (11+12); surge composition rotated back to Hair-Hybrids-only (Wegovy + Sex Rx both dormant — same shape as batches 9+10).
