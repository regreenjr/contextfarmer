...
(Wegovy was silent in batches 9-13 — diagnosed "structurally CLOSED" at the ≥3-batch threshold. **Batch 14 REOPENS the wave** with a verbatim re-launch after 5 silent batches, BREAKING that diagnosis — the 2nd "locked/closed" call broken in the farm after Anthropic's batch-11 standalone-launch break. **Methodology lesson: "structurally closed" is false-positive-prone for Hims wedges — downgrade to "dormant."** The Wegovy template is the canonical GLP-1 instantiation; six distinct ad-library entries across batches 1+4+5+7+8+14.)
