...
title: Hims
category: entity
summary: Hims & Hers Health — public DTC telehealth (NYSE:HIMS); 2026 creative engine spans three wedges (GLP-1 / hair-loss / Sex Rx) and pioneers the compounded-drug-disclaimer + "$149/mo + $39 membership" pricing template; 2026-05-10 batch adds "Hard Mints" (4th Sex Rx SKU); 2026-05-12 + 2026-05-14 + 2026-05-16 batches establish inside-structure A/B as standing pattern; the 5→6→7 sequence confirmed an alternating surge-trough cadence with multi-wedge re-launches in surge batches; 2026-05-22 batch confirmed batch-8 was fetch-gap compression (not intensification); **2026-05-23 batch 10 (1-day gap from batch 9) ships 2 more ads — 1 Hair Hybrids verbatim re-launch + 1 placeholder, Wegovy SILENT for the 2nd consecutive batch** — Hair Hybrids verbatim now spans **4 batches / 17-day stability window** with **6 cumulative post-cold-start re-launches** (1+8+9+10) and becomes the **standing late-May 2026 Hims template** as Wegovy verbatim wave appears closed (4+5+7+8 → silence 9+10); per-day rate (2.0 Hims/day) consistent with batches 8+9 (2.0-2.5/day); **3-point per-day rate confirmation** (gaps 4/2/1) locks the standing creative-ops baseline; cumulative **68 ads across 10 batches**
tags: [organization, dtc, telehealth, glp-1, compounded-drugs, hair-loss, sex-rx, hard-mints, competitor, hims, surge-trough-cadence, three-wedge-surge, fetch-gap-compression-confirmed, surge-composition-rotation, hair-hybrids-standing-template, wegovy-wave-closing]
sources: 9
updated: 2026-05-23
---
...
(Wegovy silent in batches 9 + 10 — wave appears closed; approaching but not yet at ≥3-silent-batch "wave closed" threshold.)
...
Hair Hybrids verbatim now spans **4 batches / 17-day stability window** with **6 cumulative post-cold-start re-launches**; start dates span ~12 weeks (2026-02-26 → 2026-05-19). Hair Hybrids is now the **standing late-May 2026 Hims template** — 3-consecutive-batch run (8+9+10) exceeds Wegovy on the consecutive-batch metric (Wegovy 4+5+7+8 skips batch 6). Three wedges (GLP-1, hair, sex Rx) confirmed verbatim-stable; surge composition fully rotated to Hair-Hybrids-only across batches 9+10 with Wegovy 2-batch silent (approaching but not at the ≥3-batch "wave closed" methodology threshold).
