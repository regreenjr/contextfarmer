...
category: concept
summary: The recurring three-bullet structural pattern Hims uses across all three creative wedges (GLP-1, hair, sex Rx) on FB/IG ads — hook line + "Why [Brand]?" three-bullet block + compounded-drug disclaimer; pairs with the [[compounded-drug-disclaimer]] template; 2026-05-10 surfaces a four-bullet variant for high-objection categories (Hard Mints); 2026-05-22 batch 9 confirmed batch-8 multi-wedge surge was fetch-gap compression (not intensification); **2026-05-23 batch 10 (1-day gap) ships 4th post-cold-start Hair Hybrids verbatim re-launch + 1 placeholder, Wegovy SILENT for 2nd consecutive batch** — Hair Hybrids verbatim now spans **4 batches / 17-day stability window** (1+8+9+10) with **6 cumulative post-cold-start re-launches** and **becomes the standing late-May 2026 Hims template** as Wegovy verbatim wave appears closed (4+5+7+8 → silence 9+10); 3-consecutive-batch run (8+9+10) exceeds Wegovy's stability window on consecutive-batch count; **3-point per-day rate test (batches 8+9+10 at 4/2/1-day gaps) locks ~2-2.5 Hims/day standing baseline**; inside-structure A/B testing still dominates over template variation; **OpenAI batch-9 first-copy-ad reverted to placeholder-only in batch 10 — Cluster 3 stalls at 3 ads, one-off creative test reading confirms**
tags: [dtc, telehealth, ads, copy-template, hims, glp-1, hair-loss, sex-rx, creative-pattern, surge-trough-cadence, three-wedge-surge, surge-composition-rotation, fetch-gap-compression-confirmed, hair-hybrids-standing-template, wegovy-wave-closing]
sources: 8
updated: 2026-05-23
---
