...
category: concept
summary: The recurring three-bullet structural pattern Hims uses across all three creative wedges (GLP-1, hair, sex Rx) on FB/IG ads — hook line + "Why [Brand]?" three-bullet block + compounded-drug disclaimer; pairs with the [[compounded-drug-disclaimer]] template; 2026-05-10 surfaces a four-bullet variant for high-objection categories (Hard Mints); template-stability evidence across 13 batches: Wegovy verbatim 5-batch / 14-day stability window (4+5+7+8) + Hair Hybrids verbatim across batches 1+8+9+10+13; **2026-05-28 batch 13 Hair Hybrids verbatim re-launch #7** (ID `1502428521462699` started 2026-05-14, full copy) **BREAKS the 2-batch silence (11+12)** so the wave does NOT reach the ≥3-batch wave-closure threshold — **Hair Hybrids wave remains OPEN** (the 11+12 silence was a single 2-batch trough, interpretation b, not a wave-closing pattern); **Wegovy verbatim wave remains structurally CLOSED** — now 5-batch silent (9+10+11+12+13); batch 13 also breaks the first 2-consecutive-batch all-placeholder Hims run; inside-structure A/B testing still dominates over template variation; the Hair-Hybrids three-bullet skeleton (🗓️ outcome-timeframe / 🧑🏻‍⚕️ provider-trust / 📦 shipping) is the standing late-May 2026 Hims template; OpenAI Cluster 3 still stalled at 3 ads / 1 with copy after 13 days post-launch
tags: [dtc, telehealth, ads, copy-template, hims, glp-1, hair-loss, sex-rx, creative-pattern, surge-trough-cadence, three-wedge-surge, surge-composition-rotation, fetch-gap-compression-confirmed, hair-hybrids-returns, hair-hybrids-wave-open, wegovy-wave-closed, narrative-copy-returns]
sources: 11
updated: 2026-05-28
---
