...
category: concept
summary: The pattern that emerged across the [[competitor-ads-farm]] by batch 27 (2026-07-01) — [[openai]] runs a persistent catalog-placeholder base (74 of 77 FB ads = 96%) punctuated by sporadic ONE-OFF narrative brand creatives, each on a DIFFERENT product surface targeting a DIFFERENT buyer persona and none (so far) sustained into a multi-ad campaign: batch 9 (2026-05-22) a Codex retention one-liner (dev-tool product-trial CTA, developers), batch 21 (2026-06-24) an o3 Deep Research scientific-credibility ad (Boston Children's + Harvard rare-disease study, clinicians/researchers — confirmed one-off across batches 22-26), batch 27 (2026-07-01) a ChatGPT small-business customer testimonial (James Costello / DEMTEC demolition, small-business owners — one-off pending: **batch 28's first 1-day-gap read is NON-EXPANSION**, the same revert shape as Codex batch 10 and o3 batch 22; watch batches 29-30); contrasts with [[hims]]' verbatim-template re-launch machine and with [[anthropic]]'s total own-page paid-social silence (0 copy ads across 28 batches, lab-delta now ~10.1x)
tags: [openai, ads, fb-ads, competitor-ads, narrative-ad, brand-ad, one-off-creative, codex, o3-deep-research, chatgpt, customer-testimonial, scientific-credibility, product-trial, catalog-placeholder-base, persona-targeting, ai-lab-advertising, chatgpt-testimonial-not-repeated, revert-shape, batch-28-first-read]
sources: 4
updated: 2026-07-02
---
...
- **A persistent catalog-placeholder base.** The overwhelming majority of OpenAI's ads are dynamic-creative catalog carousels with `{{product.name}}` / `{{product.brand}}` placeholders and no static narrative — 78 of 81 tracked ads (96%) as of batch 28, rolling out in launch-date "clusters."
- **Punctuated by sporadic one-off narrative creatives.** At long intervals OpenAI ships a single ad with real, creative-team-authored copy — a *brand* ad, not a catalog entry. Each has appeared once and (so far) never expanded into a sustained campaign.

The distinctive thing is that **each narrative one-off is on a different product surface and aimed at a different buyer persona** — OpenAI is not iterating one message, it is running isolated experiments across its product line.

## The three narrative ads (as of batch 27)
...
| 21 | 2026-06-24 | o3 Deep Research / Boston Children's + Harvard rare-pediatric-disease study (376 cases → 18 diagnoses, human-adjudicated) | o3 Deep Research | Clinicians / researchers | Image | Scientific-credibility / earned-proof | One-off **confirmed** (batches 22-26 no recurrence) |
| **27** | **2026-07-01** | **ChatGPT small-business customer story — James Costello / DEMTEC (NYC high-rise demolition contractor uses ChatGPT for contracts, compliance docs, construction plans)** | **ChatGPT** | **Small-business owners / prosumers** | **Image** | **Customer testimonial / use-case narrative** | **One-off pending — batch 28's first 1-day read = NON-EXPANSION (the Codex/o3 revert shape); watch batches 29-30** |
...
4. **Open methodological question — is "one-off" the rule?** Two of three (Codex, o3) are confirmed one-offs; the ChatGPT testimonial is pending — and **batch 28 delivered its first data point: a catalog-only revert (non-expansion)**, the same next-batch shape both confirmed one-offs showed. If batches 29-30 also stay copy-free, the pattern is firmly "OpenAI tests narrative creative one shot at a time and never scales it on FB." If instead a second ChatGPT customer story appears, it would be the **first sustained narrative campaign** by an AI lab in the farm.
