...
tags: [glm, glm-5-2, z-ai, zhipu, open-model, open-source-model, claude-code, harness-over-model, opus-4-8, substrate-economics, model-routing, per-project-model, token-economics, byo-model, nate-herk, cost-lever]
sources: 1
updated: 2026-06-24
---
