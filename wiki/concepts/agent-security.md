...
- [[youtube-digest-apify-2026-05-26]] — sixth citation (inter-team-scale extension via [[platform-agent-asymmetry]])
- [[platform-agent-asymmetry]] — inter-team-scale extension; goal-directed agents become unintentionally adversarial toward platform teams; private eval suite as platform-engineering survival primitive
