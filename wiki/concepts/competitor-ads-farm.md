...
category: concept
summary: Daily Apify FB Ad Library scraper farm tracking 8 brands across two competitive sets — AI consulting/3Ps positioning (Anthropic, OpenAI, Hampton, DealMachine) and GLP-1 telehealth/Medvi (Hims, Ro, Eden, Henry Meds); 6:00 AM Pacific cron; eight batches in (2026-05-06 → 2026-05-20) the dedup pipeline runs at 83-98.5% dedup-skipped with 3-36 new ads/batch (fetch-gap dependent); brand-name substring filter still untuned across all eight batches; **2026-05-20 batch ships the highest absolute signal volume since cold start — 17 tracked-brand ads (47% signal) after a 4-day fetch gap from batch 7**: Hims THREE-wedge verbatim surge (Wegovy GLP-1 verbatim across 5 batches / 14-day stability window — longest in the vault + Hair Hybrids verbatim re-launches first since cold start + 4 placeholders, 8 ads total), OpenAI 7 new ads (May 8 cluster expands 8 → 12 + **Cluster 3 opens with 2026-05-15 ads** — first OpenAI launch outside Apr 2-21/Apr 30/May 8 windows), Ro 2 ads (first non-cold-start multi-ad Ro batch), **Anthropic 0 new ads — 3rd consecutive silence LOCKS the "2026-05-11 standalone launch" diagnosis** per the batch-7 ≥3-silent-batch methodology; SecretRomance multi-cloud-variant noise (cloudn57 + cloudn65) is the **first per-page-ID-allow-listing bypass pattern** — suggests content-based dedup may eventually be required
tags: [farm, competitor-ads, fb-ads, apify, dtc, telehealth, hims, glp-1, ai-consulting, surge-trough-cadence, cluster-pacing, three-wedge-surge, cluster-3]
sources: 8
updated: 2026-05-20
---
...
The farm is at steady state. Future batches should average **3-22 new ads/day with 92-98.5% dedup** on 1-day cadence (batch 8's 36-new / 83%-dedup reflects the 4-day fetch gap). Real-signal proportion in the **0-67% band** (new mean ~34%), mean noise rate ~66%. **Batch 8's 17-ad absolute signal volume is the new high-water mark for the farm** — driven by simultaneous Hims three-wedge surge (8) + OpenAI multi-cluster expansion (7) + Ro multi-ad batch (2) hitting the same fetch window. Hims' surge-trough alternating cadence (batches 5→6→7→8) suggests interesting creative will continue to concentrate in every-other-batch surge windows.
...
**Noise rate by batch: ~65% (2026-05-06) → ~82% (2026-05-10) → 50% (2026-05-11) → 69% (2026-05-12) → 77% (2026-05-14) → 100% (2026-05-15) → 33% (2026-05-16) → 53% (2026-05-20).** Mean ~66%. Without filter tuning, the steady-state noise mix stays meaningfully present in every batch — batch 6's 100%-noise outcome is the established worst-case and batch 7's 33% is the post-cold-start best-case data point.
...
- → tune the [[competitor-ads-farm]] to use **exact page-name match** or **page-ID allow-listing** rather than substring match. **Outstanding since 2026-05-06; not addressed by 2026-05-10, 2026-05-11, 2026-05-12, 2026-05-14, 2026-05-15, 2026-05-16, or 2026-05-20 (8 consecutive batches).**
