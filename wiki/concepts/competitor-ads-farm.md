...
category: concept
summary: Daily Apify FB Ad Library scraper farm tracking 8 brands across two competitive sets — AI consulting/3Ps positioning (Anthropic, OpenAI, Hampton, DealMachine) and GLP-1 telehealth/Medvi (Hims, Ro, Eden, Henry Meds); 6:00 AM Pacific cron; twelve batches in (2026-05-06 → 2026-05-26); brand-name substring filter still untuned; batch 9 produced the structural break (OpenAI first static-narrative ad); batch 10 locked the ~8-9 ads/day baseline across 3 fetch-gap conditions; **2026-05-26 batch 12 (1-day gap) ships 6 new ads — 67% signal rate** (ties batch 7 as highest); **per-day rate (6.0/day) EXACTLY matches batch 11's 6.0/day** — second consecutive point outside the 8-9 baseline locked across batches 8+9+10 — **downward-drift hypothesis PROMOTED from "single-batch noise" to "two-point trend"**, new baseline appears to be ~6 ads/day; **first all-`{{product.brand}}`-placeholder batch in the farm** (every tracked + noise ad is dynamic-creative placeholder, no static narrative ships from any source); **[[ro]] RETURNS after 2-batch silence (10+11)** with 2 placeholders — 2-batch silence was NOT wave closure but a trough between catalog re-surface events; 2026-04-14 launch window confirmed as canonical Ro template (6+ weeks active); **[[hims]] drops to 1 ad** (lowest-volume Hims batch outside silence batches 3+6) — batches 11+12 form first 2-consecutive-batch all-placeholder Hims run; **Wegovy 4-batch silent (9+10+11+12)** extending structurally-closed wave; **Hair Hybrids 2nd consecutive silence (11+12)** approaching ≥3-batch wave-closure threshold; **[[openai]] returns from batch-11 silence** with Cluster 2 expansion (now 14 ads / 18 days post-launch at 0.78/day); Cluster 3 STILL stalled at 3 ads / 1 with copy after 11 days; **[[anthropic]] silent batch 12** (1 batch since slow-cluster expansion, can't yet confirm pattern); **Eden Munoz joins multi-batch verbatim-noise repeat tier** (3-batch non-consecutive 3+7+12, each surfacing from different launch date)
tags: [farm, competitor-ads, fb-ads, apify, dtc, telehealth, hims, glp-1, ai-consulting, surge-trough-cadence, cluster-pacing, three-wedge-surge, cluster-3, openai-first-copy-ad-one-off, codex-retention-narrative-stalled, fetch-gap-compression-confirmed, surge-composition-rotation, downward-drift-confirmed, wegovy-wave-closed, hair-hybrids-2nd-silence, anthropic-slow-cluster-revealed, all-placeholder-batch, ro-returns-from-silence, eden-munoz-multi-batch-noise]
sources: 12
updated: 2026-05-26
---
