...
category: concept
summary: Daily Apify FB Ad Library scraper farm tracking 8 brands across two competitive sets — AI consulting/3Ps positioning (Anthropic, OpenAI, Hampton, DealMachine) and GLP-1 telehealth/Medvi (Hims, Ro, Eden, Henry Meds); 6:00 AM Pacific cron; thirteen batches in (2026-05-06 → 2026-05-28); brand-name substring filter still untuned; batch 9 produced the structural break (OpenAI first static-narrative ad); batch 10 locked the ~8-9 ads/day baseline; **2026-05-28 batch 13 (2-day gap) ships 8 new ads — 50% signal rate**; **[[eden]] (TryEden) ships its FIRST real telehealth signal in 13 batches** — the bare-"Eden" filter finally captures the actual GLP-1-telehealth competitor after 12 batches of pure "Eden"-substring noise (new entity [[eden]] created); **[[hims]] RETURNS to 2 ads — Hair Hybrids verbatim re-launch #7 BREAKS the 2-batch Hair Hybrids silence (11+12)** so the wave does NOT close — **Hair Hybrids wave remains OPEN** (11+12 was a single 2-batch trough, not wave closure) + 1 placeholder; breaks the first 2-consecutive all-placeholder Hims run; **Wegovy 5-batch silent (9+10+11+12+13)** — wave still closed; **[[openai]] ships 1 placeholder** with a NEW 2026-05-22 launch date (possible Cluster 4 opening at 1 ad); Cluster 3 still stalled at 3 ads / 1 with copy; **[[anthropic]] 2nd consecutive silence (12+13)** — next 2026-05-11-cluster ad expected ~2026-06-08 if 14-day cadence holds, can't yet confirm stall; **[[ro]] 1-batch trough** after batch-12's 2-ad return; **per-day rate (4.0/day) drops below batch 11+12's 6.0/day** — 3-point declining sequence (6.0 → 6.0 → 4.0) undercuts the batch-12 "~6/day baseline" reading, likely a multi-brand coordinated trough; **narrative copy RETURNS** after batch 12's all-placeholder batch (4 of 8 ads carry copy); **both long-form Cholesterol confession narratives return simultaneously** (Relief Community 11→13 + Support Group 8→13) + new Thai-language Punpromotion noise + Eden and Om bamboo sheets (returns from cold-start batch 1)
tags: [farm, competitor-ads, fb-ads, apify, dtc, telehealth, hims, glp-1, ai-consulting, surge-trough-cadence, cluster-pacing, three-wedge-surge, cluster-3, openai-first-copy-ad-one-off, codex-retention-narrative-stalled, fetch-gap-compression-confirmed, surge-composition-rotation, downward-drift-continues, wegovy-wave-closed, hair-hybrids-returns, hair-hybrids-wave-open, anthropic-2nd-silence, all-placeholder-batch, ro-returns-from-silence, eden-first-signal, narrative-copy-returns, cholesterol-narratives-return]
sources: 13
updated: 2026-05-28
---
...
**Noise rate by batch: ~65% (2026-05-06) → ~82% (2026-05-10) → 50% (2026-05-11) → 69% (2026-05-12) → 77% (2026-05-14) → 100% (2026-05-15) → 33% (2026-05-16) → 53% (2026-05-20) → 41% (2026-05-22) → 62.5% (2026-05-23) → 75% (2026-05-25).** Mean ~64%. Without filter tuning, the steady-state noise mix stays meaningfully present in every batch — batch 6's 100%-noise outcome is the established worst-case and batch 7's 33% is the post-cold-start best-case data point.
