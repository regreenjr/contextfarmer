...
category: concept
summary: Daily Apify FB Ad Library scraper farm tracking 8 brands across two competitive sets — AI consulting/3Ps positioning (Anthropic, OpenAI, Hampton, DealMachine) and GLP-1 telehealth/Medvi (Hims, Ro, Eden, Henry Meds); 6:00 AM Pacific cron; ten batches in (2026-05-06 → 2026-05-23) the dedup pipeline runs at 83-98.5% dedup-skipped with 3-36 new ads/batch (fetch-gap dependent); brand-name substring filter still untuned across all ten batches; batch 9 produced the structural break (OpenAI first static-narrative ad); **2026-05-23 batch 10 (1-day gap from batch 9) ships 8 new ads — 37.5% signal rate** — **three-point per-day rate test (batches 8+9+10 at 4-day/2-day/1-day gaps) locks the ~8-9 ads/day standing creative-ops baseline** at typical 1-4-day cadence; **OpenAI reverts to placeholder-only** (Cluster 1 expansion carousel) — **batch-9 Codex retention video was a one-off creative test, not a sustained campaign opening**; Cluster 3 stalls at 3 ads / 1 with copy after 8 days post-launch (vs Cluster 2's 12 ads / 15 days); Hims continues Hair Hybrids verbatim surge (4-batch / 17-day stability window with 6 cumulative post-cold-start re-launches — becomes the standing late-May 2026 template) while Wegovy 2-batch silent; Anthropic 4th consecutive silence post-2026-05-11 (standalone diagnosis remains LOCKED); SecretRomance-cloudn65 3-consecutive-batch verbatim repeat (8+9+10) overtakes Lauren Brooks as the new most-consistent verbatim noise repeat
tags: [farm, competitor-ads, fb-ads, apify, dtc, telehealth, hims, glp-1, ai-consulting, surge-trough-cadence, cluster-pacing, three-wedge-surge, cluster-3, openai-first-copy-ad-one-off, codex-retention-narrative-stalled, fetch-gap-compression-confirmed, surge-composition-rotation, baseline-locked, hair-hybrids-standing-template]
sources: 10
updated: 2026-05-23
---
...
**Noise rate by batch: ~65% (2026-05-06) → ~82% (2026-05-10) → 50% (2026-05-11) → 69% (2026-05-12) → 77% (2026-05-14) → 100% (2026-05-15) → 33% (2026-05-16) → 53% (2026-05-20) → 41% (2026-05-22) → 62.5% (2026-05-23).** Mean ~63%. Without filter tuning, the steady-state noise mix stays meaningfully present in every batch — batch 6's 100%-noise outcome is the established worst-case and batch 7's 33% is the post-cold-start best-case data point.
